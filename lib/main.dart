        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              subtitle: Text(
                  'seria sobre um programa pra ajudar a rrumar estoque de casa ',
                  style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                      fontStyle: FontStyle.italic)),
            ...
            ListTile(
              ...
              title: Text('projeto 2',
                  style: TextStyle(fontSize: 32, color: Colors.grey)),
              subtitle: Text('programa padrao pra aajudar a cadastrar cliente ',
                  style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                      fontStyle: FontStyle.italic)),
            ...
            ListTile(
              ...
              title: Text('quem crio o programa',
                  style: TextStyle(fontSize: 32, color: Colors.grey)),
              subtitle: Text('imformação sobre o criador do programa ',
                  style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                      fontStyle: FontStyle.italic)),
...
class _Pro1 extends State<Pro1> {
  ...
  void initState() {
    super.initState();
    lista.add('onestamente quero fazer esse projeto');
...
class _Criador extends State<Criador> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Fotos('Nicholas Campanelli Abreu', 'cod: 826895', 'lib/FOTOS/eu.jpeg'),
